    ...
    >
      <div className="w-full max-w-md bg-card/95 backdrop-blur-sm p-8 rounded-lg shadow-xl">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-secondary rounded py-2.5 font-medium text-foreground hover:bg-secondary/50 transition mb-5"
        >
